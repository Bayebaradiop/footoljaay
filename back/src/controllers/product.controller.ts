...
export class ProductController {
  ...
  async getProducts(req: Request, res: Response) {
    try {
      ...
      // Si l'utilisateur est connecté, ne montrer que ses propres produits
      if (userId) {
        filters.sellerId = userId;
        // Pour les utilisateurs connectés, montrer tous leurs produits quel que soit le statut
        // sauf si un statut spécifique est demandé
        filters.status = status as ProductStatus | undefined;
      } else {
        // Pour les utilisateurs non connectés (public), ne montrer que les produits approuvés
